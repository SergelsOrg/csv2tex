...
class ShellCommandsUtilTest {
    ...
    // TODO run as part of test group that signals that the system has all utilities installed!
    @Test
    ...
    // TODO run as part of test group that signals that the system has some utilities missing!
//    @Test
