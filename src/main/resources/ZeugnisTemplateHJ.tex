...
%	\renewcommand{\arraystretch}{1}
	\begin{tabularx}{\linewidth}{|X|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|}
		\hline
...
\newcommand\competencyMS[2]{#1 & #2}
\newcommand\competencySS[3]{#1 & #3 #2}

\newcommand\competencytable[2]{
%	\renewcommand{\arraystretch}{1}
	\begin{tabularx}{\linewidth}{|K{X}|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|C{.07\linewidth}|}
		\hline
...
\begin{document}
	...
	\begin{minipage}[t][.98\textheight][t]{.97\textwidth}
			...
			\begin{tabularx}{\linewidth}{@{}lX}
				...
				Versäumnisse: & 0 Tage (davon 0 Tage unentschuldigt) \\
				
				&  0 Stunden (davon 0 Stunden unentschuldigt) \\
