...
\begin{document}
	...
	\begin{minipage}[t][.98\textheight][t]{.97\textwidth}
			...
			\begin{tabularx}{\linewidth}{@{}lX}
				Versäumnisse: & #absenceDays  Tage (davon #absenceDaysUnauthorized Tage unentschuldigt) \\
				&  #absenceHours Stunden (davon #absenceHoursUnauthorized Stunden unentschuldigt) \\
			\end{tabularx}
			\vspace{3cm}\\
