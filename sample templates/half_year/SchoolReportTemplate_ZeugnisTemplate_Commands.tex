...
\newcommand{\gradeHalfYear}{& \multicolumn{4}{c|}{wird im 2. Halbjahr belegt}\\\hline}
...
\newcommand\competencyMajorSubject[2]{\makecell[l]{#1} & #2}
\newcommand\competencyMinorSubject[3]{\makecell[l]{#1} & #3 #2}
